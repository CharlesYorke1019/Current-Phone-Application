        ...
        <View style={{flex: 1, justifyContent: 'center', backgroundColor: 'mistyrose', borderWidth: 8, borderRadius: 10, borderColor: 'lightgrey'}}>
            ...
            <View style={{borderWidth: 3, width: '100%', height: '30%', backgroundColor: 'papayawhip', borderRadius: 5, position: 'absolute', top: 120, display: editAccountInfo === false && editUserGameInfo === false && initDeleteAccount === false ? 'flex' : 'none'}}>
                ...
                <View>
                    ...
                    <TouchableOpacity style={{borderWidth: 3, borderRadius: 5, backgroundColor: 'lavender', width: '30%', alignSelf: 'center', position: 'absolute', top: 160}}
            ...
            <View style={{display: initDeleteAccount === true ? 'flex' : 'none', width: '80%', height: '33%', borderWidth: 3, borderRadius: 5, backgroundColor: 'papayawhip', position: 'absolute', top: '33%', alignSelf: 'center'}}>
                ...
                <View style={{flexDirection: 'row', alignSelf: 'center'}}>
                    <TouchableOpacity style={{borderWidth: 3, borderRadius: 5, backgroundColor: 'lavender', alignSelf: 'center', marginRight: 20}}
